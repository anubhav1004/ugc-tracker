"""
Bulk add TikTok accounts using pytok scraper
"""
...
from scrapers.pytok_scraper import PyTokScraper
...
async def add_accounts():
    ...
    print("🚀 Starting bulk account import with pytok...")
        ...
        for idx, url in enumerate(PROFILE_URLS, 1):
            ...
            try:
                ...
                for video_data in profile_data['videos']:
                    ...
                    if existing:
                        ...
                        for key, value in video_data.items():
                            if key not in ['id', 'platform', 'created_at']:  # Don't update these
                ...
                if profile_data['videos']:
                    ...
                    print(f"\n⚠️  No videos found for @{username}")
