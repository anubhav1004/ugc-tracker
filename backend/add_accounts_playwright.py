"""
Bulk add TikTok accounts using Playwright scraper
"""
...
async def add_accounts():
    ...
    print("🚀 Starting bulk account import with Playwright...")
    print(f"📋 Adding {len(PROFILE_URLS)} accounts")
    print("⚠️  This may take 5-10 minutes as we scrape each profile...")
    print()
